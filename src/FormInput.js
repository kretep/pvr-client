...
export class FormInput extends React.Component {
  ...
  constructor(props) {
    super(props);
    const { name, value, label, pattern, requiredMessage, patternMessage, autoFocus } = this.props;
    this.state = { name, value, label, pattern, requiredMessage, patternMessage, autoFocus };
  }
  ...
  render() {
    const { name, value, label, pattern, requiredMessage, patternMessage, autoFocus } = this.state;
    return (
